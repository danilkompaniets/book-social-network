...
import com.danilkompaniets.book_network.book.BookRepository;
...
public class FeedbackService {
    ...
    public PageResponse<FeedbackResponse> findAllFeedbacksByBook(Authentication connectedUser, Integer bookId, int page, int size, Authentication connectedUser1) {
